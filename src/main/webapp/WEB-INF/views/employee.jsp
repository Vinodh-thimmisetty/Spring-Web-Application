...
<body>
	...
	<script>
		...
		function clientsidevalidation(){
			var currentForm = document.forms["addEmployee"];
...
<%-- 
	<form:form
		...
		commandName="employeeDTO" modelAttribute="employeeDTO" name="addEmployee"
		id="addEmployee" method="POST" class="form-horizontal" onsubmit="return clientsidevalidation()">
		<form:errors path="*" cssClass="errorblock" element="div" />
		<div class="form-group">
			<label class="control-label col-sm-2" for="empName">Employee
				Name:</label>
			<div class="col-sm-2">
				<form:input path="empName" class="form-control" required="required" pattern="[a-z]{5,25}"  />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<form:input path="emailId" class="form-control"  required="required" pattern="([a-zA-Z0-9.]){3,}@(\1){2,}.[com|in|edu]" oninvalid="setCustomValidity('Plz enter on Alphabets ')"/>
			</div>
		</div>
		...
		<div class="form-group">
			<label class="control-label col-sm-2" for="phoneNum">Phone
				Number: </label>
			<div class="col-sm-2">
				<form:input path="phoneNum" class="form-control" pattern="[0-9]{10}"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				<form:input path="weight" class="form-control" pattern="\d+"/>
			</div>
		</div>
		...
		<spring:bind path="dateOfBirth">
			<div class="form-group">
				<label class="control-label col-sm-2" for="dateOfBirth">Date
					of Birth: </label>
				<div class="col-sm-2">
					<form:input path="dateOfBirth" class="form-control" id="datepicker"  required="required" />
				</div>
			</div>
	...
	<form:form
		action="${pageContext.request.contextPath}/docs/addEmployee2.tsp"
		commandName="employeeDTO" modelAttribute="employeeDTO" name="addEmployee"
		id="addEmployee2" method="POST" class="form-horizontal">
		<form:errors path="*" cssClass="errorblock" element="div" />
		<div class="form-group">
			<label class="control-label col-sm-2" for="empName">Employee
				Name:</label>
